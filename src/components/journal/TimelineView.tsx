...
export default function TimelineView({
  ...
  return (
    <div className="space-y-3" ref={containerRef}>
      ...
      <div className="sticky top-0 z-30 bg-stone-950 pt-2 pb-2 sm:pt-3 sm:pb-2 transition-all">
        <div className="bg-stone-900 border border-stone-800/80 rounded-2xl p-2 sm:p-2.5">
          ...
          <div className="flex items-center gap-1 bg-stone-950/60 border border-stone-800/80 p-1 rounded-xl w-full sm:w-auto overflow-x-auto scrollbar-none">
            <button
              type="button"
          ...
          <div className="flex items-center gap-2 w-full sm:w-auto justify-between sm:justify-end">
            {/* Entry Type Selector */}
            <div className="flex items-center gap-1 bg-stone-950/60 border border-stone-800/80 p-0.5 rounded-xl">
              {(
                [
      ...
      {filteredDaysData.validDays.length > 0 ? (
        ...
        <div className="py-24 text-center text-stone-500 select-none bg-stone-900/40 border border-dashed border-stone-800/80 rounded-2xl p-8">
